define('src/js/reducers/admin/column/list', function(require, exports, module) {
  ...
  var initalize = {
      ...
      titleList: [{ title: "栏目名称", type: "provinceName" }, { title: "栏目名称", type: "provinceName" }, { title: "栏目名称", type: "provinceName" }, { title: "栏目名称", type: "provinceName" }, { title: "栏目名称", type: "provinceName" }, { title: "栏目名称", type: "provinceName" }]
  };
