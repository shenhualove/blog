define('src/js/reducers/admin/column/list', function(require, exports, module) {
  ...
  var initalize = {
      ...
      titleList: [{ title: "栏目名称", type: "title" }, { title: "栏目关键字", type: "keyWord" }, { title: "栏目说明", type: "provinceName" }, { title: "栏目排序", type: "provinceName" }, { title: "添加时间", type: "provinceName" }, { title: "操作", type: "provinceName" }]
  };
