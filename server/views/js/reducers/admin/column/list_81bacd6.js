define('src/js/reducers/admin/column/list', function(require, exports, module) {
  ...
  var initalize = {
      ...
      titleList: [{ title: "栏目名称", type: "provinceName" }, { title: "栏目关键字", type: "provinceName" }, { title: "栏目说明", type: "provinceName" }, { title: "栏目排序", type: "provinceName" }, { title: "栏目名称", type: "provinceName" }, { title: "栏目名称", type: "provinceName" }]
  };
