define('src/js/reducers/admin/article/list', function(require, exports, module) {
  ...
  var initalize = {
      ...
      titleList: [{ title: "文章名称", type: "title" }, { title: "所属栏目", type: "keyWord" }, { title: "", type: "caption" }, { title: "栏目排序", type: "sort" }, { title: "添加时间", type: "time" }, { title: "操作", htmlType: [{ type: "button", text: "修改", callBack: null }, { type: "button", text: "删除", callBack: null }] }]
  };
