define('src/js/reducers/admin/article/list', function(require, exports, module) {
  ...
  var initalize = {
      ...
      titleList: [{ title: "文章名称", type: "title" }, { title: "所属栏目", type: "keyWord" }, { title: "缩略图", type: "caption" }, { title: "文章作者", type: "sort" }, { title: "文章来源", type: "time" }, { title: "操作", htmlType: [{ type: "button", text: "修改", callBack: null }, { type: "button", text: "删除", callBack: null }] }]
  };
