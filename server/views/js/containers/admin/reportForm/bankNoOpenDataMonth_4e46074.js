define('src/js/containers/admin/reportForm/bankNoOpenDataMonth', function(require, exports, module) {
  ...
  var _actionsReportFormBankNoOpenDataMonth = require('../../actions/reportForm/bankNoOpenDataMonth');
  ...
  var bankNoOpenDataMonthMain = (function (_React$Component) {
      _inherits(bankNoOpenDataMonthMain, _React$Component);
  
      function bankNoOpenDataMonthMain() {
          _classCallCheck(this, bankNoOpenDataMonthMain);
  
          _get(Object.getPrototypeOf(bankNoOpenDataMonthMain.prototype), 'constructor', this).apply(this, arguments);
      }
  
      _createClass(bankNoOpenDataMonthMain, [{
          key: 'selectClick',
          value: function selectClick(id, val, name) {
              switch (id) {
                  case 1:
                      this.props._bankNoOpenDataMonthHandle({
          ...
          value: function pageNavClick(curPage, pageSize, options) {
              this.getData(curPage, pageSize, options ? options : this.props.bankNoOpenDataMonth.temp_options);
          }
          ...
          value: function getData(curPage, pageSize, options) {
              ...
              this.props._bankNoOpenDataMonthLoad({
                  curPage: curPage,
                  pageSize: pageSize,
          ...
          value: function submitClick() {
              if (this.props.bankNoOpenDataMonth.status == 'loading') {
                  ...
                  var options = {
                      selectDate: this.props.bankNoOpenDataMonth.selectDate, //默认日期
                      province: this.props.bankNoOpenDataMonth.province, //选中的省
                      city: this.props.bankNoOpenDataMonth.city, //选中的城市
                      county: this.props.bankNoOpenDataMonth.county, //选中的县
                      bank: this.props.bankNoOpenDataMonth.bank };
                  //选中的银行
                  this.props._bankNoOpenDataMonthHandle({
                      temp_options: options
                  });
                  this.getData(1, this.props.bankNoOpenDataMonth.pageSize, options);
              }
          }
          ...
          value: function exportExcel() {
              var options = this.props.bankNoOpenDataMonth.temp_options;
              this.props._bankNoOpenDataMonthExport({
                  reportType: 1,
                  reportDate: options.selectDate + '-01',
                  provinceName: options.province.name == '全部' ? '' : options.province.name,
                  cityName: options.city.name == '全部' ? '' : options.city.name,
          ...
          value: function componentDidMount() {
              ...
              $(function () {
                  ...
                  $("#datepicker").datepicker({
                      ...
                      onClose: function onClose(dateText, inst) {
                          ...
                          _that.props._bankNoOpenDataMonthHandle({
              ...
              this.props._getBankTypeCodes({ reportName: "bankbizstopDetailMonth" });
          }
      }, {
          key: 'render',
          value: function render() {
              return _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(_componentsPublicCenterTopNav2['default'], { title: '银行业务未开展站点明细月报', parentList: [{ name: "数据报表" }, { name: "银行业务月报" }] }),
                  _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement('input', { type: 'text', readOnly: true, id: 'datepicker', value: this.props.bankNoOpenDataMonth.selectDate })
                              ),
                              _react2['default'].createElement(
                                  'li',
                                  null,
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankNoOpenDataMonth.province.val,
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankNoOpenDataMonth.city.val,
                                      list: this.showCity()
                                  })
                              ),
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankNoOpenDataMonth.county.val,
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankNoOpenDataMonth.bank,
                                      list: this.showBank()
                                  })
                              )
                          ),
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsReportFormExportButton2['default'], {
                                  data: this.props.login.Jurisdiction.ReportForm.btns.bankNoOpenDataMonth,
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsPublicReportFormTable2['default'], { colspan: 12, status: this.props.bankNoOpenDataMonth.status, dataList: this.props.bankNoOpenDataMonth.listData, titleList: this.props.bankNoOpenDataMonth.titleList })
                          ),
                          _react2['default'].createElement(_componentsPublicPagination2['default'], {
                              curPage: this.props.bankNoOpenDataMonth.curPage,
                              totalNumber: this.props.bankNoOpenDataMonth.totalSize,
                              pageLimt: this.props.bankNoOpenDataMonth.pageSize,
      ...
      return bankNoOpenDataMonthMain;
  ...
  function mapDispatchToProps(dispatch) {
      return {
          _bankNoOpenDataMonthHandle: function _bankNoOpenDataMonthHandle(options) {
              dispatch((0, _actionsReportFormBankNoOpenDataMonth.bankNoOpenDataMonthHandle)(options));
          },
          _bankNoOpenDataMonthLoad: function _bankNoOpenDataMonthLoad(options) {
              dispatch((0, _actionsReportFormBankNoOpenDataMonth.bankNoOpenDataMonthLoad)(options));
          },
          ...
          _bankNoOpenDataMonthExport: function _bankNoOpenDataMonthExport(options) {
              dispatch((0, _actionsReportFormBankNoOpenDataMonth.bankNoOpenDataMonthExport)(options));
          }
      };
  }
  
  var bankNoOpenDataMonth = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(bankNoOpenDataMonthMain);
  
  exports['default'] = bankNoOpenDataMonth;
  module.exports = exports['default'];
  /*form content begin*/ /*form content end*/ /*content begin*/ /*content end*/
  //# sourceMappingURL=/js/containers/admin/reportForm/bankNoOpenDataMonth.js.map
