define('src/js/containers/admin/reportForm/siteAddDataMonth', function(require, exports, module) {
  ...
  var _actionsReportFormSiteAddDataMonth = require('../../actions/reportForm/siteAddDataMonth');
  ...
  var siteAddDataMonthMain = (function (_React$Component) {
      _inherits(siteAddDataMonthMain, _React$Component);
  
      function siteAddDataMonthMain() {
          _classCallCheck(this, siteAddDataMonthMain);
  
          _get(Object.getPrototypeOf(siteAddDataMonthMain.prototype), 'constructor', this).apply(this, arguments);
      }
  
      _createClass(siteAddDataMonthMain, [{
              ...
              $(function () {
                  $("#datepicker").datepicker({
                      ...
                      onClose: function onClose(dateText, inst) {
                          ...
                          _that.props._siteAddDataMonthHandle({
          ...
          value: function loadPage(options) {
              this.props._siteAddDataMonthHandle({
                  loadPageFlag: false
              });
          ...
          value: function pageNavClick(n, pageSize, options) {
              ...
              if (n == Math.ceil(this.props.siteAddDataMonth.totalSize / pageSize)) {
                  //当前是最后一页
                  this.props._siteAddDataMonthHandle({
                      showTotal: true
                  });
              ...
              this.loadData(n, pageSize, options ? options : this.props.siteAddDataMonth.temp_options);
          }
          ...
          value: function loadData(n, pageSize, options) {
              ...
              //银行code
              this.props._siteAddDataMonthLoadData({
                  data: ajaxData
              });
          }
      }, {
          ...
          value: function queryData() {
              if (this.props.siteAddDataMonth.tbodyList == 'loading') {
                  ...
                  var options = {
                      reportDate: this.props.siteAddDataMonth.reportDate, //报表类型(日/月)
                      province: this.props.siteAddDataMonth.province, //省名字
                      bank: this.props.siteAddDataMonth.bank };
                  //银行code
                  this.props._siteAddDataMonthHandle({
                      tbodyList: 'loading',
          ...
          value: function exportExcel() {
              var options = this.props.siteAddDataMonth.temp_options;
              this.props._siteAddDataMonthExport({
                  reportType: "1", //报表类型(日/月)
                  reportDate: options.reportDate + '-01', //数据日期
                  provinceName: options.province.name == '全部' ? '' : options.province.name, //省名字
                  bankTypeCode: options.bank == '全部' ? '' : options.bank });
          ...
          value: function render() {
              return _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(_componentsPublicCenterTopNav2['default'], { title: '全辖站点增量月报', parentList: [{ name: "数据报表" }, { name: "银行业务月报" }] }),
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement('input', { id: 'datepicker', type: 'text', value: this.props.siteAddDataMonth.reportDate, readOnly: true })
                              ),
                              _react2['default'].createElement(
                                  'li',
                                  null,
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.siteAddDataMonth.province.val,
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.siteAddDataMonth.bank,
                                      list: this.showBank()
                                  })
                              )
                          ),
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsReportFormExportButton2['default'], {
                                  data: this.props.login.Jurisdiction.ReportForm.btns.siteAddDataMonth,
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsPublicReportFormTable2['default'], {
                                  showTotal: this.props.siteAddDataMonth.showTotal,
                                  totalData: this.props.siteAddDataMonth.totalData,
                                  totalTitle: this.props.siteAddDataMonth.totalTitle,
                                  dataList: this.props.siteAddDataMonth.tableList,
                                  titleList: this.props.siteAddDataMonth.tableTitle,
                                  colspan: 10,
                                  status: this.props.siteAddDataMonth.tbodyList
                              })
                          ),
                          _react2['default'].createElement(_componentsPublicPagination2['default'], {
                              curPage: this.props.siteAddDataMonth.curPage,
                              totalNumber: this.props.siteAddDataMonth.totalSize,
                              pageLimt: this.props.siteAddDataMonth.pageLimit,
  ...
  function mapDispatchToProps(dispatch) {
      return {
          _siteAddDataMonthHandle: function _siteAddDataMonthHandle(options) {
              dispatch((0, _actionsReportFormSiteAddDataMonth.siteAddDataMonthHandle)(options));
          },
          _siteAddDataMonthLoadData: function _siteAddDataMonthLoadData(options) {
              dispatch((0, _actionsReportFormSiteAddDataMonth.siteAddDataMonthLoadData)(options));
          },
          ...
          _siteAddDataMonthExport: function _siteAddDataMonthExport(options) {
              dispatch((0, _actionsReportFormSiteAddDataMonth.siteAddDataMonthExport)(options));
          }
  
      };
  }
  var siteAddDataMonth = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(siteAddDataMonthMain);
  
  exports['default'] = siteAddDataMonth;
  module.exports = exports['default'];
  /*form content begin*/ /*form content end*/ /*content begin*/ /*content end*/
  //# sourceMappingURL=/js/containers/admin/reportForm/siteAddDataMonth.js.map
