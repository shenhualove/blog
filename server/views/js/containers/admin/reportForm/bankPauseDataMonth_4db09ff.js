define('src/js/containers/admin/reportForm/bankPauseDataMonth', function(require, exports, module) {
  ...
  var _actionsReportFormBankPauseDataMonth = require('../../actions/reportForm/bankPauseDataMonth');
  ...
  var bankPauseDataMonthMain = (function (_React$Component) {
      _inherits(bankPauseDataMonthMain, _React$Component);
  
      function bankPauseDataMonthMain() {
          _classCallCheck(this, bankPauseDataMonthMain);
  
          _get(Object.getPrototypeOf(bankPauseDataMonthMain.prototype), 'constructor', this).apply(this, arguments);
      }
  
      _createClass(bankPauseDataMonthMain, [{
          key: 'selectClick',
          value: function selectClick(id, val, name) {
              switch (id) {
                  case 1:
                      this.props._bankPauseDataMonthHandle({
          ...
          value: function pageNavClick(curPage, pageSize, options) {
              this.getData(curPage, pageSize, options ? options : this.props.bankPauseDataMonth.temp_options);
          }
          ...
          value: function getData(curPage, pageSize, options) {
              ...
              this.props._bankPauseDataMonthLoad({
                  curPage: curPage,
                  pageSize: pageSize,
          ...
          value: function submitClick() {
              if (this.props.bankPauseDataMonth.status == 'loading') {
                  ...
                  var options = {
                      selectDate: this.props.bankPauseDataMonth.selectDate, //默认日期
                      province: this.props.bankPauseDataMonth.province, //选中的省
                      city: this.props.bankPauseDataMonth.city, //选中的城市
                      county: this.props.bankPauseDataMonth.county, //选中的县
                      bank: this.props.bankPauseDataMonth.bank };
                  //选中的银行
                  this.props._bankPauseDataMonthHandle({
                      temp_options: options
                  });
                  this.getData(1, this.props.bankPauseDataMonth.pageSize, options);
              }
          }
          ...
          value: function exportExcel() {
              var options = this.props.bankPauseDataMonth.temp_options;
              this.props._bankPauseDataMonthExport({
                  reportType: 1,
                  reportDate: options.selectDate + '-01',
                  provinceName: options.province.name == '全部' ? '' : options.province.name,
                  cityName: options.city.name == '全部' ? '' : options.city.name,
          ...
          value: function componentDidMount() {
              ...
              $(function () {
                  ...
                  $("#datepicker").datepicker({
                      ...
                      onClose: function onClose(dateText, inst) {
                          ...
                          _that.props._bankPauseDataMonthHandle({
              ...
              this.props._queryProvince({ reportName: "bankbizpauseDetail" });
              this.props._getBankTypeCodes({ reportName: "bankbizpauseDetailMonth" });
          }
      }, {
          key: 'render',
          value: function render() {
              return _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(_componentsPublicCenterTopNav2['default'], { title: '银行业务暂停站点明细月报', parentList: [{ name: "数据报表" }, { name: "银行业务月报" }] }),
                  _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement('input', { type: 'text', readOnly: true, id: 'datepicker', value: this.props.bankPauseDataMonth.selectDate })
                              ),
                              _react2['default'].createElement(
                                  'li',
                                  null,
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankPauseDataMonth.province.val,
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankPauseDataMonth.city.val,
                                      list: this.showCity()
                                  })
                              ),
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankPauseDataMonth.county.val,
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankPauseDataMonth.bank,
                                      list: this.showBank()
                                  })
                              )
                          ),
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsReportFormExportButton2['default'], {
                                  data: this.props.login.Jurisdiction.ReportForm.btns.bankPauseDataMonth,
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsPublicReportFormTable2['default'], { width: '120%', colspan: 15, status: this.props.bankPauseDataMonth.status, dataList: this.props.bankPauseDataMonth.listData, titleList: this.props.bankPauseDataMonth.titleList })
                          ),
                          _react2['default'].createElement(_componentsPublicPagination2['default'], {
                              curPage: this.props.bankPauseDataMonth.curPage,
                              totalNumber: this.props.bankPauseDataMonth.totalSize,
                              pageLimt: this.props.bankPauseDataMonth.pageSize,
  ...
  function mapDispatchToProps(dispatch) {
      return {
          _bankPauseDataMonthHandle: function _bankPauseDataMonthHandle(options) {
              dispatch((0, _actionsReportFormBankPauseDataMonth.bankPauseDataMonthHandle)(options));
          },
          _bankPauseDataMonthLoad: function _bankPauseDataMonthLoad(options) {
              dispatch((0, _actionsReportFormBankPauseDataMonth.bankPauseDataMonthLoad)(options));
          },
          ...
          _bankPauseDataMonthExport: function _bankPauseDataMonthExport(options) {
              dispatch((0, _actionsReportFormBankPauseDataMonth.bankPauseDataMonthExport)(options));
          }
      };
  }
  
  var bankPauseDataMonth = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(bankPauseDataMonthMain);
  
  exports['default'] = bankPauseDataMonth;
  module.exports = exports['default'];
  /*form content begin*/ /*form content end*/ /*content begin*/ /*content end*/
  //# sourceMappingURL=/js/containers/admin/reportForm/bankPauseDataMonth.js.map
