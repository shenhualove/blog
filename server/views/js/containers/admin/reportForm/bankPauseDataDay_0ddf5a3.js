define('src/js/containers/admin/reportForm/bankPauseDataDay', function(require, exports, module) {
  ...
  var _actionsReportFormBankPauseDataDay = require('../../actions/reportForm/bankPauseDataDay');
  ...
  var bankPauseDataDayMain = (function (_React$Component) {
      _inherits(bankPauseDataDayMain, _React$Component);
  
      function bankPauseDataDayMain() {
          _classCallCheck(this, bankPauseDataDayMain);
  
          _get(Object.getPrototypeOf(bankPauseDataDayMain.prototype), 'constructor', this).apply(this, arguments);
      }
  
      _createClass(bankPauseDataDayMain, [{
          key: 'selectClick',
          value: function selectClick(id, val, name) {
              switch (id) {
                  case 1:
                      this.props._bankPauseDataDayHandle({
          ...
          value: function pageNavClick(curPage, pageSize, options) {
              this.getData(curPage, pageSize, options ? options : this.props.bankPauseDataDay.temp_options);
          }
          ...
          value: function getData(curPage, pageSize, options) {
              ...
              this.props._bankPauseDataDayLoad({
                  curPage: curPage,
                  pageSize: pageSize,
          ...
          value: function submitClick() {
              if (this.props.bankPauseDataDay.status == 'loading') {
                  ...
                  var options = {
                      selectDate: this.props.bankPauseDataDay.selectDate, //默认日期
                      province: this.props.bankPauseDataDay.province, //选中的省
                      city: this.props.bankPauseDataDay.city, //选中的城市
                      county: this.props.bankPauseDataDay.county, //选中的县
                      bank: this.props.bankPauseDataDay.bank };
                  //选中的银行
                  this.props._bankPauseDataDayHandle({
                      temp_options: options
                  });
                  this.getData(1, this.props.bankPauseDataDay.pageSize, options);
              }
          }
          ...
          value: function exportExcel() {
              var options = this.props.bankPauseDataDay.temp_options;
              this.props._bankPauseDataDayExport({
                  reportType: 0,
                  reportDate: options.selectDate,
                  provinceName: options.province.name == '全部' ? '' : options.province.name,
                  cityName: options.city.name == '全部' ? '' : options.city.name,
          ...
          value: function componentDidMount() {
              this.resetData(true);
              //重置页码
              if (this.props.bankPauseDataDay.pageSize != 10) {
                  this.props._bankPauseDataDayHandle({
                      pageSize: 10
                  });
              }
              ...
              $(function () {
                  $("#datepicker").datepicker({
                      ...
                      onSelect: function onSelect(date) {
                          _that.props._bankPauseDataDayHandle({
                              selectDate: date
                          });
                      }
                  });
              ...
              this.props._getBankTypeCodes({ reportName: "bankbizpauseDetail" });
          }
      }, {
          key: 'render',
          value: function render() {
              return _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(_componentsPublicCenterTopNav2['default'], { title: '银行业务暂停站点明细日报', parentList: [{ name: "数据报表" }, { name: "银行业务日报" }] }),
                  _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement('input', { type: 'text', readOnly: true, id: 'datepicker', value: this.props.bankPauseDataDay.selectDate })
                              ),
                              _react2['default'].createElement(
                                  'li',
                                  null,
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankPauseDataDay.province.val,
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankPauseDataDay.city.val,
                                      list: this.showCity()
                                  })
                              ),
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankPauseDataDay.county.val,
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankPauseDataDay.bank,
                                      list: this.showBank()
                                  })
                              )
                          ),
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsReportFormExportButton2['default'], {
                                  data: this.props.login.Jurisdiction.ReportForm.btns.bankPauseDataDay,
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsPublicReportFormTable2['default'], { width: '120%', colspan: 15, status: this.props.bankPauseDataDay.status, dataList: this.props.bankPauseDataDay.listData, titleList: this.props.bankPauseDataDay.titleList })
                          ),
                          _react2['default'].createElement(_componentsPublicPagination2['default'], {
                              curPage: this.props.bankPauseDataDay.curPage,
                              totalNumber: this.props.bankPauseDataDay.totalSize,
                              pageLimt: this.props.bankPauseDataDay.pageSize,
  ...
  function mapDispatchToProps(dispatch) {
      return {
          _bankPauseDataDayHandle: function _bankPauseDataDayHandle(options) {
              dispatch((0, _actionsReportFormBankPauseDataDay.bankPauseDataDayHandle)(options));
          },
          _bankPauseDataDayLoad: function _bankPauseDataDayLoad(options) {
              dispatch((0, _actionsReportFormBankPauseDataDay.bankPauseDataDayLoad)(options));
          },
          ...
          _bankPauseDataDayExport: function _bankPauseDataDayExport(options) {
              dispatch((0, _actionsReportFormBankPauseDataDay.bankPauseDataDayExport)(options));
          }
      };
  }
  
  var bankPauseDataDay = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(bankPauseDataDayMain);
  
  exports['default'] = bankPauseDataDay;
  module.exports = exports['default'];
  /*form content begin*/ /*form content end*/ /*content begin*/ /*content end*/
  //# sourceMappingURL=/js/containers/admin/reportForm/bankPauseDataDay.js.map
