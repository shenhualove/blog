define('src/js/containers/admin/reportForm/bankRoutineDataDay', function(require, exports, module) {
  ...
  var _actionsReportFormBankRoutineDataDay = require('../../actions/reportForm/bankRoutineDataDay');
  ...
  var bankRoutineDataDayMain = (function (_React$Component) {
      _inherits(bankRoutineDataDayMain, _React$Component);
  
      function bankRoutineDataDayMain() {
          _classCallCheck(this, bankRoutineDataDayMain);
  
          _get(Object.getPrototypeOf(bankRoutineDataDayMain.prototype), 'constructor', this).apply(this, arguments);
      }
  
      _createClass(bankRoutineDataDayMain, [{
          key: 'selectClick',
          value: function selectClick(id, val, name) {
              switch (id) {
                  case 1:
                      this.props._bankRoutineDataDayHandle({
          ...
          value: function pageNavClick(curPage, pageSize, options) {
              if (curPage == Math.ceil(this.props.bankRoutineDataDay.totalSize / pageSize)) {
                  //当前是最后一页
                  this.props._bankRoutineDataDayHandle({
                      showTotal: true
                  });
              ...
              this.getData(curPage, pageSize, options ? options : this.props.bankRoutineDataDay.temp_options);
          }
          ...
          value: function getData(curPage, pageSize, options) {
              ...
              this.props._bankRoutineDataDayLoad({
                  curPage: curPage,
                  pageSize: pageSize,
          ...
          value: function submitClick() {
              if (this.props.bankRoutineDataDay.status == 'loading') {
                  ...
                  var options = {
                      selectDate: this.props.bankRoutineDataDay.selectDate, //默认日期
                      province: this.props.bankRoutineDataDay.province, //选中的省
                      bank: this.props.bankRoutineDataDay.bank };
                  //选中的银行
                  this.props._bankRoutineDataDayHandle({
                      temp_options: options
                  });
                  this.getData(1, this.props.bankRoutineDataDay.pageSize, options);
              }
          }
          ...
          value: function exportExcel() {
              var options = this.props.bankRoutineDataDay.temp_options;
              this.props._bankRoutineDataDayExport({
                  reportType: 0,
                  reportDate: options.selectDate,
                  provinceName: options.province.name == '全部' ? '' : options.province.name,
                  bankTypeCode: options.bank == '全部' ? '' : options.bank
          ...
          value: function componentDidMount() {
              ...
              $(function () {
                  $("#datepicker").datepicker({
                      ...
                      onSelect: function onSelect(date) {
                          _that.props._bankRoutineDataDayHandle({
                              selectDate: date
                          });
                      }
                  });
              ...
              this.props._getBankTypeCodes({ reportName: "bankbizFull" });
          }
      }, {
          key: 'render',
          value: function render() {
              return _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(_componentsPublicCenterTopNav2['default'], { title: '全辖银行业务全量银行数据汇总日报', parentList: [{ name: "数据报表" }, { name: "银行业务日报" }] }),
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement('input', { type: 'text', readOnly: true, id: 'datepicker', value: this.props.bankRoutineDataDay.selectDate })
                              ),
                              _react2['default'].createElement(
                                  'li',
                                  null,
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankRoutineDataDay.province.val,
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankRoutineDataDay.bank,
                                      list: this.showBank()
                                  })
                              )
                          ),
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsReportFormExportButton2['default'], {
                                  data: this.props.login.Jurisdiction.ReportForm.btns.bankRoutineDataDay,
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsPublicReportFormTable2['default'], { colspan: 7,
                                  showTotal: this.props.bankRoutineDataDay.showTotal,
                                  status: this.props.bankRoutineDataDay.status,
                                  totalData: this.props.bankRoutineDataDay.totalData,
                                  totalTitle: this.props.bankRoutineDataDay.totalTitle,
                                  dataList: this.props.bankRoutineDataDay.listData,
                                  titleList: this.props.bankRoutineDataDay.titleList })
                          ),
                          _react2['default'].createElement(_componentsPublicPagination2['default'], {
                              curPage: this.props.bankRoutineDataDay.curPage,
                              totalNumber: this.props.bankRoutineDataDay.totalSize,
                              pageLimt: this.props.bankRoutineDataDay.pageSize,
  ...
  function mapDispatchToProps(dispatch) {
      return {
          _bankRoutineDataDayHandle: function _bankRoutineDataDayHandle(options) {
              dispatch((0, _actionsReportFormBankRoutineDataDay.bankRoutineDataDayHandle)(options));
          },
          _bankRoutineDataDayLoad: function _bankRoutineDataDayLoad(options) {
              dispatch((0, _actionsReportFormBankRoutineDataDay.bankRoutineDataDayLoad)(options));
          },
          ...
          _bankRoutineDataDayExport: function _bankRoutineDataDayExport(options) {
              dispatch((0, _actionsReportFormBankRoutineDataDay.bankRoutineDataDayExport)(options));
          }
      };
  }
  
  var bankRoutineDataDay = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(bankRoutineDataDayMain);
  
  exports['default'] = bankRoutineDataDay;
  module.exports = exports['default'];
  /*form content begin*/ /*form content end*/ /*content begin*/ /*content end*/
  //# sourceMappingURL=/js/containers/admin/reportForm/bankRoutineDataDay.js.map
