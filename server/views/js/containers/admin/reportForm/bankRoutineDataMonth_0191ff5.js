define('src/js/containers/admin/reportForm/bankRoutineDataMonth', function(require, exports, module) {
  ...
  var _actionsReportFormBankRoutineDataMonth = require('../../actions/reportForm/bankRoutineDataMonth');
  ...
  var bankRoutineDataMonthMain = (function (_React$Component) {
      _inherits(bankRoutineDataMonthMain, _React$Component);
  
      function bankRoutineDataMonthMain() {
          _classCallCheck(this, bankRoutineDataMonthMain);
  
          _get(Object.getPrototypeOf(bankRoutineDataMonthMain.prototype), 'constructor', this).apply(this, arguments);
      }
  
      _createClass(bankRoutineDataMonthMain, [{
          key: 'selectClick',
          value: function selectClick(id, val, name) {
              switch (id) {
                  case 1:
                      this.props._bankRoutineDataMonthHandle({
          ...
          value: function pageNavClick(curPage, pageSize, options) {
              if (curPage == Math.ceil(this.props.bankRoutineDataMonth.totalSize / pageSize)) {
                  //当前是最后一页
                  this.props._bankRoutineDataMonthHandle({
                      showTotal: true
                  });
              ...
              this.getData(curPage, pageSize, options ? options : this.props.bankRoutineDataMonth.temp_options);
          }
          ...
          value: function getData(curPage, pageSize, options) {
              ...
              this.props._bankRoutineDataMonthLoad({
                  curPage: curPage,
                  pageSize: pageSize,
          ...
          value: function submitClick() {
              if (this.props.bankRoutineDataMonth.status == 'loading') {
                  ...
                  var options = {
                      selectDate: this.props.bankRoutineDataMonth.selectDate, //默认日期
                      province: this.props.bankRoutineDataMonth.province, //选中的省
                      bank: this.props.bankRoutineDataMonth.bank };
                  //选中的银行
                  this.props._bankRoutineDataMonthHandle({
                      temp_options: options
                  });
                  this.getData(1, this.props.bankRoutineDataMonth.pageSize, options);
              }
          }
          ...
          value: function exportExcel() {
              var options = this.props.bankRoutineDataMonth.temp_options;
              this.props._bankRoutineDataMonthExport({
                  reportType: 1,
                  reportDate: options.selectDate + '-01',
                  provinceName: options.province.name == '全部' ? '' : options.province.name,
                  bankTypeCode: options.bank == '全部' ? '' : options.bank
          ...
          value: function componentDidMount() {
              ...
              $(function () {
                  ...
                  $("#datepicker").datepicker({
                      ...
                      onClose: function onClose(dateText, inst) {
                          ...
                          _that.props._bankRoutineDataMonthHandle({
              ...
              this.props._queryProvince({ reportName: "bankbizFull" });
              this.props._getBankTypeCodes({ reportName: "bankbizFullMonth" });
          }
      }, {
          key: 'render',
          value: function render() {
              return _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(_componentsPublicCenterTopNav2['default'], { title: '全辖银行业务全量银行数据汇总月报', parentList: [{ name: "数据报表" }, { name: "银行业务月报" }] }),
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement('input', { type: 'text', readOnly: true, id: 'datepicker', value: this.props.bankRoutineDataMonth.selectDate })
                              ),
                              _react2['default'].createElement(
                                  'li',
                                  null,
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankRoutineDataMonth.province.val,
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.bankRoutineDataMonth.bank,
                                      list: this.showBank()
                                  })
                              )
                          ),
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsReportFormExportButton2['default'], {
                                  data: this.props.login.Jurisdiction.ReportForm.btns.bankRoutineDataMonth,
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsPublicReportFormTable2['default'], { colspan: 7,
                                  showTotal: this.props.bankRoutineDataMonth.showTotal,
                                  status: this.props.bankRoutineDataMonth.status,
                                  totalData: this.props.bankRoutineDataMonth.totalData,
                                  totalTitle: this.props.bankRoutineDataMonth.totalTitle,
                                  dataList: this.props.bankRoutineDataMonth.listData,
                                  titleList: this.props.bankRoutineDataMonth.titleList })
                          ),
                          _react2['default'].createElement(_componentsPublicPagination2['default'], {
                              curPage: this.props.bankRoutineDataMonth.curPage,
                              totalNumber: this.props.bankRoutineDataMonth.totalSize,
                              pageLimt: this.props.bankRoutineDataMonth.pageSize,
      ...
      return bankRoutineDataMonthMain;
  ...
  function mapDispatchToProps(dispatch) {
      return {
          _bankRoutineDataMonthHandle: function _bankRoutineDataMonthHandle(options) {
              dispatch((0, _actionsReportFormBankRoutineDataMonth.bankRoutineDataMonthHandle)(options));
          },
          _bankRoutineDataMonthLoad: function _bankRoutineDataMonthLoad(options) {
              dispatch((0, _actionsReportFormBankRoutineDataMonth.bankRoutineDataMonthLoad)(options));
          },
          ...
          _bankRoutineDataMonthExport: function _bankRoutineDataMonthExport(options) {
              dispatch((0, _actionsReportFormBankRoutineDataMonth.bankRoutineDataMonthExport)(options));
          }
      };
  }
  
  var bankRoutineDataMonth = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(bankRoutineDataMonthMain);
  
  exports['default'] = bankRoutineDataMonth;
  module.exports = exports['default'];
  /*form content begin*/ /*form content end*/ /*content begin*/ /*content end*/
  //# sourceMappingURL=/js/containers/admin/reportForm/bankRoutineDataMonth.js.map
