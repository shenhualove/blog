define('src/js/containers/admin/reportForm/siteNewFinishDataMonth', function(require, exports, module) {
  ...
  var _actionsReportFormSiteNewFinishDataMonth = require('../../actions/reportForm/siteNewFinishDataMonth');
  ...
  var siteNewFinishDataMonthMain = (function (_React$Component) {
      _inherits(siteNewFinishDataMonthMain, _React$Component);
  
      function siteNewFinishDataMonthMain() {
          _classCallCheck(this, siteNewFinishDataMonthMain);
  
          _get(Object.getPrototypeOf(siteNewFinishDataMonthMain.prototype), 'constructor', this).apply(this, arguments);
      }
  
      _createClass(siteNewFinishDataMonthMain, [{
          ...
          value: function componentDidMount() {
              ...
              $(function () {
                  $("#datepicker").datepicker({
                      ...
                      onClose: function onClose(dateText, inst) {
                          ...
                          _that.props._siteNewFinishDataMonthHandle({
              ...
              this.props._getBankTypeCodes({
                  reportName: "nodedropdataincMonthlyMonth"
              });
          ...
          value: function loadPage(options) {
              this.props._siteNewFinishDataMonthHandle({
                  loadPageFlag: false
              });
          ...
          value: function pageNavClick(n, pageSize, options) {
              ...
              this.loadData(n, pageSize, options ? options : this.props.siteNewFinishDataMonth.temp_options);
          }
          ...
          value: function loadData(n, pageSize, options) {
              ...
              //站点编号
              this.props._siteNewFinishDataMonthLoadData({
                  data: ajaxData
              });
          }
          ...
          value: function queryData() {
              if (this.props.siteNewFinishDataMonth.tbodyList == 'loading') {
                  ...
                  var siteNumCheck = $.XlCheck({
                      val: this.props.siteNewFinishDataMonth.siteNum,
                      rule: ["Number"]
                  });
                  ...
                  var options = {
                      reportDate: this.props.siteNewFinishDataMonth.reportDate, //数据日期
                      province: this.props.siteNewFinishDataMonth.province, //选中的省
                      city: this.props.siteNewFinishDataMonth.city, //选中的城市
                      county: this.props.siteNewFinishDataMonth.county, //选中的县
                      department: this.props.siteNewFinishDataMonth.department, //部门code
                      bank: this.props.siteNewFinishDataMonth.bank, //银行code
                      siteName: this.props.siteNewFinishDataMonth.siteName, //站点名称
                      siteNum: this.props.siteNewFinishDataMonth.siteNum };
                  //站点编号
                  this.props._siteNewFinishDataMonthHandle({
                      tbodyList: 'loading',
                      temp_options: options
                  });
                  this.loadData(1, this.props.siteNewFinishDataMonth.pageLimit, options);
              }
          }
          ...
          value: function exportExcel() {
              var options = this.props.siteNewFinishDataMonth.temp_options;
              this.props._siteNewFinishDataMonthExport({
                  reportType: "1", //报表类型(日/月)
                  reportDate: options.reportDate + '-01', //数据日期
                  provinceName: options.province.name == "全部" ? "" : options.province.name, //省
                  cityName: options.city.name == "全部" ? "" : options.city.name, //市
          ...
          value: function render() {
              return _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(_componentsPublicCenterTopNav2['default'], { title: '月新增落地站点明细月报', parentList: [{ name: "数据报表" }, { name: "银行业务月报" }] }),
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement('input', { id: 'datepicker', type: 'text', value: this.props.siteNewFinishDataMonth.reportDate, readOnly: true })
                              ),
                              _react2['default'].createElement(_componentsReportFormRegional2['default'], {
                                  selectClick: this.selectClick.bind(this),
                                  provinceVal: this.props.siteNewFinishDataMonth.province.val,
                                  cityVal: this.props.siteNewFinishDataMonth.city.val,
                                  countyVal: this.props.siteNewFinishDataMonth.county.val,
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicDepartment2['default'], { value: this.props.siteNewFinishDataMonth.department.name,
                              ...
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(_componentsPublicSelectBox2['default'], {
                                      ...
                                      value: this.props.siteNewFinishDataMonth.bank,
                                      list: this.showBank()
                                  })
                              ),
                              _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement('input', { type: 'text', placeholder: '请输入站点名称', onChange: this.siteNameFun.bind(this), value: this.props.siteNewFinishDataMonth.siteName })
                              ),
                              _react2['default'].createElement(
                                  'li',
                                  null,
                                  ...
                                  _react2['default'].createElement('input', { type: 'text', placeholder: '请输入站点编号', onChange: this.siteNumFun.bind(this), value: this.props.siteNewFinishDataMonth.siteNum })
                              )
                          ),
                          _react2['default'].createElement(
                              'div',
                              ...
                              _react2['default'].createElement(_componentsReportFormExportButton2['default'], {
                                  data: this.props.login.Jurisdiction.ReportForm.btns.siteNewFinishDataMonth,
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(_componentsPublicReportFormTable2['default'], {
                                  dataList: this.props.siteNewFinishDataMonth.tableList,
                                  titleList: this.props.siteNewFinishDataMonth.tableTitle,
                                  colspan: 13,
                                  status: this.props.siteNewFinishDataMonth.tbodyList
                              })
                          ),
                          _react2['default'].createElement(_componentsPublicPagination2['default'], {
                              curPage: this.props.siteNewFinishDataMonth.curPage,
                              totalNumber: this.props.siteNewFinishDataMonth.totalSize,
                              pageLimt: this.props.siteNewFinishDataMonth.pageLimit,
      ...
      return siteNewFinishDataMonthMain;
  ...
  function mapDispatchToProps(dispatch) {
      return {
          _siteNewFinishDataMonthHandle: function _siteNewFinishDataMonthHandle(options) {
              dispatch((0, _actionsReportFormSiteNewFinishDataMonth.siteNewFinishDataMonthHandle)(options));
          },
          _siteNewFinishDataMonthLoadData: function _siteNewFinishDataMonthLoadData(options) {
              dispatch((0, _actionsReportFormSiteNewFinishDataMonth.siteNewFinishDataMonthLoadData)(options));
          },
          ...
          _siteNewFinishDataMonthExport: function _siteNewFinishDataMonthExport(options) {
              dispatch((0, _actionsReportFormSiteNewFinishDataMonth.siteNewFinishDataMonthExport)(options));
          }
  
      };
  }
  var siteNewFinishDataMonth = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(siteNewFinishDataMonthMain);
  
  exports['default'] = siteNewFinishDataMonth;
  module.exports = exports['default'];
  /*form content begin*/ /*form content end*/ /*content begin*/ /*content end*/
  //# sourceMappingURL=/js/containers/admin/reportForm/siteNewFinishDataMonth.js.map
