  ...
  function mapDispatchToProps(dispatch) {
      return {
          _loginHandle: function _loginHandle(options) {
              dispatch((0, _actionsAdmin.loginHandle)(options));
          },
          ...
          _sendMessage: function _sendMessage(options) {
              dispatch((0, _actionsAdmin.sendMessage)(options));
          },
          _smsBiz: function _smsBiz(options) {
              dispatch((0, _actionsAdmin.smsBiz)(options));
          },
          _validateSmsCode: function _validateSmsCode(options) {
              dispatch((0, _actionsAdmin.validateSmsCode)(options));
          },
          _getPartyId: function _getPartyId(options) {
              dispatch((0, _actionsAdmin.getPartyId)(options));
          },
          _submitPassword: function _submitPassword(options) {
              dispatch((0, _actionsAdmin.submitPassword)(options));
          }
      };
  }
