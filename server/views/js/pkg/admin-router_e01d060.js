...
define('src/js/containers/admin/column/list', function(require, exports, module) {
  ...
  var _componentsAdminActionsDialog = require('../../../components/admin/actions/dialog');
  ...
  var _actionsAdminColumnList = require('../../../actions/admin/column/list');
      ...
      _createClass(List, [{
          ...
          value: function render() {
              return _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(_componentsAdminCommonCenterTopNav2['default'], { title: '全辖银行业务常规数据汇总日报', parentList: [{ name: "数据报表" }, { name: "银行业务日报" }] }),
                  _react2['default'].createElement(
                      'div',
...
define('src/js/containers/admin/article/list', function(require, exports, module) {
  ...
  var List = (function (_React$Component) {
      ...
      _createClass(List, [{
          key: 'render',
          value: function render() {
              return _react2['default'].createElement('div', { className: 'height100p' });
          }
      }]);
