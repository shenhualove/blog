...
define('src/js/reducers/admin/dialog', function(require, exports, module) {
  ...
  var initalize = {
      ...
      title: '', //弹窗标题
      type: 'confirm', //弹窗类型  confirm / loading / tips
...
define('src/js/reducers/admin/column/list', function(require, exports, module) {
  ...
  var initalize = {
      ...
      titleList: [{ title: "栏目名称", type: "title" }, { title: "栏目关键字", type: "keyWord" }, { title: "栏目说明", type: "caption" }, { title: "栏目排序", type: "sort" }, { title: "添加时间", type: "time" }, { title: "操作", htmlType: [{ type: "button", text: "修改", callBack: null, param: "id" }, { type: "button", text: "删除", callBack: null, param: "id" }] }]
  };
...
define('src/js/reducers/admin/article/list', function(require, exports, module) {
  ...
  var initalize = {
      ...
      totalSize: 0, //总条数
      status: "loading", //默认请求加载中
      titleList: [{ title: "文章名称", type: "title" }, { title: "所属栏目", type: "columnName" }, { title: "文章作者", type: "author" }, { title: "文章来源", type: "source" }, { title: "浏览次数", type: "totalViews" }, { title: "添加时间", type: "time" }, { title: "操作", htmlType: [{ type: "button", text: "修改", callBack: null, param: "id" }, { type: "button", text: "删除", callBack: null, param: "id" }] }]
  };
