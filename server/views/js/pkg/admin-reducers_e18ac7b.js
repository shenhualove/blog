...
define('src/js/reducers/admin/article/list', function(require, exports, module) {
  ...
  var initalize = {
      ...
      totalSize: 0, //总条数
      status: "loading", //默认请求加载中
      titleList: [{ title: "文章名称", type: "title" }, { title: "所属栏目", type: "keyWord" }, { title: "缩略图", type: "imgUrl" }, { title: "文章作者", type: "sort" }, { title: "文章来源", type: "time" }, { title: "浏览次数", type: "sort" }, { title: "添加时间", type: "time" }, { title: "操作", htmlType: [{ type: "button", text: "修改", callBack: null }, { type: "button", text: "删除", callBack: null }] }]
  };
