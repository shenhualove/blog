;/*!/src/js/utils/common/fetch.js*/
define('src/js/utils/common/fetch', function(require, exports, module) {
  ...
  var urls = {
      ...
      getArticleList: "/admin/getArticleList" };
  ...
  function Fetch(options) {
      ...
      //初始化请求
      var sendUrl = new Request(host + urls[options.url]); //构造请求资源
      fetch(sendUrl, sendHeader).then(function (res) {
          if (res.ok) {
              ...
              if (typeof options.error === "function") {
                  options.error(res.status, errText);
              };
          }
      }, function (e) {
          alert("网络异常，请求错误");
  ...
  //# sourceMappingURL=/js/utils/common/fetch.js.map
  

});

;/*!/src/js/utils/common/moment.js*/
define('src/js/utils/common/moment', function(require, exports, module) {
  ...
  !(function (a, b) {
    ...
    "use strict";function a() {
      ...
      var d,
          ...
          g = 0;for (d = 0; e > d; d++) (c && a[d] !== b[d] || !c && q(a[d]) !== q(b[d])) && g++;return g + f;
      ...
      var b,
          c,
          d = {};for (c in a) f(a, c) && (b = A(c), b && (d[b] = a[c]));return d;
    }function C(b, c) {
      return function (d) {
      ...
      var b,
          c,
          d = a.match(Nc);for (b = 0, c = d.length; c > b; b++) Qc[d[b]] ? d[b] = Qc[d[b]] : d[b] = I(d[b]);return function (e) {
      ...
      var b,
          ...
          e,
          f = [];if (!a._d) {
        for (d = sa(a), a._w && null == a._a[hd] && null == a._a[gd] && ua(a), a._dayOfYear && (e = ra(a._a[fd], d[fd]), a._dayOfYear > ga(e) && (j(a)._overflowDayOfYear = !0), c = fa(e, 0, a._dayOfYear), a._a[gd] = c.getUTCMonth(), a._a[hd] = c.getUTCDate()), b = 0; 3 > b && null == a._a[b]; ++b) a._a[b] = f[b] = d[b];for (; 7 > b; b++) a._a[b] = f[b] = null == a._a[b] ? 2 === b ? 1 : 0 : a._a[b];24 === a._a[id] && 0 === a._a[jd] && 0 === a._a[kd] && 0 === a._a[ld] && (a._nextDay = !0, a._a[id] = 0), a._d = (a._useUTC ? fa : ea).apply(null, f), null != a._tzm && a._d.setUTCMinutes(a._d.getUTCMinutes() - a._tzm), a._nextDay && (a._a[id] = 24);
      }
    }function ua(a) {
      ...
      if (("number" == typeof a && (b = a, a = void 0), a = a || "", null != b)) return hc(a, b, c, e);var f,
          g = [];for (f = 0; d > f; f++) g[f] = hc(a, f, c, e);return g;
    }function jc(a, b) {
  ...
  //! momentjs.com
  //# sourceMappingURL=/js/utils/common/moment.js.map
